...
Diese Referenz gilt für die **deutsche Spracheinstellung**. In anderen Sprachen (Englisch, Spanisch, Französisch, Italienisch, Portugiesisch) ändert sich nur das Schlüsselwort (z.B. `WENN` -> `IF`), die Logik bleibt identisch.
